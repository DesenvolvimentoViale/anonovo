      ...
      <div className="container">
        <div className="footer-top">
          ...
          <div className="footer-column">
            <h3>Sobre</h3>
            <ul>
              <li><a href="https://www.vialehoteis.com.br/">Nossa História</a></li>
              <li><a href="https://www.vialehoteis.com.br/">Imprensa</a></li>
              <li><a href="https://www.vialehoteis.com.br/">Trabalhe Conosco</a></li>
            </ul>
          </div>
          <div className="footer-column">
            <h3>Contato</h3>
        ...
        <div className="footer-middle">
          <a href="https://www.vialehoteis.com.br/" className="footer-logo">
        ...
        <hr className="footer-divider" />
        <div className="footer-bottom"><p>© 2025 Viale Hotéis. Todos os direitos reservados.</p></div>
      </div>
    </footer>
  );
};
